...
- The 32-dimension fingerprint encoder captures play style, pacing, and interaction patterns
...
- The FullStory behavioral profile (`d904a09b-80d2-4d38-81bf-6784a500da6a`) produces structured archetype/intent/state annotations for each session
